...
public class LightEcomV1Application implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        categoryRepository.save(new Category(1L,"Computers",null,null,null));
        categoryRepository.save(new Category(2L,"Printers",null,null,null));
        categoryRepository.save(new Category(3L,"Smart phones",null,null,null));

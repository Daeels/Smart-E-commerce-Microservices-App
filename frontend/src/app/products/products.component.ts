...
export class ProductsComponent implements OnInit {
  ...
  ngOnInit() {
    this.router.events.subscribe((val) => {
      if (val instanceof NavigationEnd ) {
        ...
        if(p1==1){
          ...
          this.title="Recherche...";
          this.title="Recherche intelligente";
          this.products= JSON.parse(localStorage.getItem('tttt'))
    ...
    if(p1==1){
      ...
      this.title="Recherche intelligente";
      this.products= JSON.parse(localStorage.getItem('tttt'))
      console.log(JSON.parse(localStorage.getItem('tttt')))
  ...
  private getProducts_f(url) {
    this.catService.getResource(this.catService.host_flask+url)
      .subscribe(data=>{
        this.products=data;
      },err=>{
        console.log(err);
